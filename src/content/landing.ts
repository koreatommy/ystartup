...
export const publicLanding = {
  problem: {
    title: "창업 교육, 왜 항상 어렵게 느껴질까요?",
    body: "아이디어는 떠올라도 어디서부터 시작해야 할지 막막합니다. 자료는 많지만 순서가 없고, 실습은 있지만 체계가 부족합니다.",
    bridgeBody: "Y-START는 이 문제를 해결하기 위해 만들어졌습니다.",
  },
  solution: {
    title: "10단계로 따라가는 창업 교육",
    body: "Y-START는 창업 과정을 하나의 흐름으로 설계했습니다. 각 단계는 독립적인 학습이 아니라, 다음 단계로 이어지는 구조로 구성되어 있습니다.",
    detail:
      "아이디어 발상부터 시장 분석, 실행 전략, 피칭까지 한 단계씩 따라가면 자연스럽게 창업 전체 흐름을 이해할 수 있습니다.",
  },
  features: [
    {
      title: "10단계 워크북 학습",
      body: "팀 구성부터 사업 실행까지, 창업 과정을 단계별 워크북으로 제공합니다.",
      icon: "BookOpen" as const,
    },
    {
      title: "PDF 실습 기능",
      body: "브라우저에서 바로 워크북을 열고, 필기와 주석을 통해 직접 작성하며 학습할 수 있습니다.",
      icon: "FileEdit" as const,
    },
    {
      title: "Root Hunter 보조 학습",
      body: "5 Whys 기반 활동을 통해 문제의 원인을 깊이 탐색하고 사고를 확장할 수 있습니다.",
      icon: "Search" as const,
    },
    {
      title: "시각화 기반 학습",
      body: "간트 차트, 손익분기점 등 시각 자료를 통해 복잡한 개념을 쉽게 이해할 수 있습니다.",
      icon: "BarChart3" as const,
    },
  ],
  experience: {
    title: "보고 끝나는 학습이 아닙니다",
    body: "워크북을 직접 작성하고, 문제를 분석하고, 아이디어를 구체화하고, 결과물을 만들어내는 과정까지 포함되어 있습니다.",
    highlight:
      "Y-START는 '이해'가 아니라 '실행'을 중심으로 설계되었습니다.",
  },
  bottomCta: {
    title: "당신의 창업 아이디어를 현실로 만들어보세요",
    body: "Y-START의 10단계 워크북과 함께라면 아이디어는 계획이 되고, 계획은 실행으로 이어집니다.",
    ctaPrimary: "지금 시작하기",
    ctaSecondary: "전체 커리큘럼 보기",
  },
  footer:
    "Y-START는 청소년 창업 교육을 위한 디지털 워크북 학습 플랫폼입니다. 단계별 구조와 실습 중심 설계를 통해 실제 창업 경험을 제공합니다.",
};
